...
<form action="{{ route('orders.update', $order->id) }}" method="post">
      ...
      @endif
      <label for="name">Edit Order</label>
      <label for="tour_name">Назва Тура</label>
      <input type="text" name="tour_name" value = '{{ $order->tour_name }}'>
      <label for="price">Ціна</label>
      <input type="text" name="price" value = '{{ $order->price }}'>
      <label for="days">Кількість днів</label>
      <input type="text" name="days" value = '{{ $order->days }}'>
      <label for="telephone">Номер телефона</label>
      <input type="tel" name="telephone" value = '{{ $order->phone_number }}'>
      <label for="email">Email</label> 
      <input type="email" name="email" value = '{{ $order->email }}'>
      <label for="fullname">ПІП</label>
      <input type="text" name="fullname" value = '{{ $order->fullname }}'>

      <div class = "foot-btn">
        <a href="{{ route('orders') }}">Cancel</a>
